...
| **Overall Status**| 🟡 In Progress (Documentation 90% Complete) |
...
| Metric | Status | Notes |
|--------|--------|-------|
| **Documentation** | 🟢 90% Complete | PRD, Content, TDD, Design, Wireframe, DB, SEO, Deploy done |
| **Environment Setup** | 🔴 0% Complete | VPS & Local Repo belum di-setup |
| **Frontend Dev** | 🔴 0% Complete | Belum mulai coding |
| **Backend Dev** | 🔴 0% Complete | Ditargetkan untuk V1.5 |
| **Deployment** | 🔴 0% Complete | Menunggu dev selesai |
| **Timeline** | 🟢 On Track | Target launch V1: Akhir bulan ini |

---

## ✅ Phase 1: Documentation & Planning (Foundation)
*Status: Hampir Selesai. Review final sebelum masuk ke coding.*
...
*Status: Belum Dimulai. Estimasi: 1-2 Hari.*

### 2.1 Local Development Setup
- [ ] Install Node.js (v20+) dan Go (v1.22+) di laptop Advan Workpro.
- [ ] Initialize Git repository (`git init`).
- [ ] Buat struktur folder monorepo sesuai TDD (`apps/web`, `apps/api`, `infra`, `docs`).
- [ ] Setup `Makefile` di root untuk command shortcut (`make dev-web`, `make dev-api`).
- [ ] Buat file `.gitignore` dan `.env.example`.
...
*Status: Belum Dimulai. Estimasi: 5-7 Hari. Kerjakan section by section.*

### 3.1 Project Initialization
- [ ] `npm create astro@latest` di folder `apps/web`.
- [ ] Install & configure Tailwind CSS.
- [ ] Setup global styles, fonts (Inter), dan Tailwind config (sesuai Design System).
- [ ] Setup `@astrojs/sitemap` dan file `robots.txt`.

### 3.2 Component Development (UI Library)
- [ ] Buat komponen dasar: `Button.astro`, `Card.astro`, `Container.astro`, `Badge.astro`.
- [ ] Buat komponen form: `Input.astro`, `Textarea.astro`, `Select.astro`.
- [ ] Setup Icon library (Lucide Astro).

### 3.3 Section Implementation (Sesuai Wireframe)
- [ ] **S1: Navbar** - Sticky, responsive, hamburger menu mobile.
- [ ] **S2: Hero Section** - Headline, sub-headline, 2 CTA buttons, visual/gradient.
- [ ] **S3: Problem Section** - 3 cards grid, responsive.
- [ ] **S4: Services Section** - 3 cards dengan bullet points fitur.
- [ ] **S5: Why Webifylab** - 2x2 grid, icon + description.
- [ ] **S6: Approach Section** - 4 steps horizontal (desktop) / vertical (mobile).
- [ ] **S7: Portfolio Section** - 3 placeholder cards dengan "Coming Soon" overlay.
- [ ] **S8: Testimonial** - (Optional) Hide atau buat placeholder.
- [ ] **S9: CTA / Contact** - Form (integrate Formspree/Web3Forms) + WhatsApp button.
- [ ] **S10: Footer** - Multi-column, social links, copyright.

### 3.4 Pages & Routing
- [ ] `index.astro` (Landing page utama, assemble semua sections).
- [ ] `404.astro` (Custom not found page).
- [ ] `privacy.astro` & `terms.astro` (Optional, basic text).

---

## ⚙️ Phase 4: Backend Development (Golang - V1.5)
*Status: Backlog. Akan dikerjakan setelah V1 Landing Page live.*
...
*Status: Belum Dimulai. Lakukan sebelum deploy production.*
...
*Status: Belum Dimulai. Estimasi: 1 Hari.*
...
- *[Tambahkan log perkembangan di sini]*
