...
## 1. Tone of Voice & Writing Guidelines
...
| **Description** | Bisnis Anda butuh sistem yang terintegrasi — bukan sekadar halaman statis yang tidak menghasilkan apa-apa. |

**Card 2:**
| Elemen | Content |
|--------|---------|
| **Icon** | Handshake / Partnership |
| **Title** | Vendor yang Hilang Setelah Proyek Selesai |
| **Description** | Anda butuh partner jangka panjang yang memahami bisnis Anda, bukan vendor yang hanya datang saat ada proyek. |

**Card 3:**
| Elemen | Content |
|--------|---------|
| **Icon** | Brain / AI |
| **Title** | Tidak Siap Menghadapi Era AI & Data |
| **Description** | Kompetitor Anda sudah mulai otomatisasi dan menggunakan data. Apakah Anda siap tertinggal? |
...
| **Description** | Kami membangun aplikasi web dan mobile yang scalable, dengan arsitektur yang siap berkembang bersama bisnis Anda. |
| **Features List** | • Web Application (SaaS, Dashboard, Internal Tools) • Mobile Application (Android & iOS) • API Development & Integration • Sistem Legacy Modernization |
| **CTA** | Pelajari Lebih Lanjut → |

**Card 2 — Desain Grafis & Web Design:**
| Elemen | Content |
|--------|---------|
| **Icon** | Palette / Design |
| **Title** | Desain Grafis & Web Design |
| **Description** | Visual yang konsisten dan profesional untuk membangun brand yang kuat dan pengalaman pengguna yang optimal. |
| **Features List** | • UI/UX Design (Website & Aplikasi) • Brand Identity (Logo, Guidelines) • Marketing Collateral (Banner, Social Media) • Design System & Component Library |
| **CTA** | Pelajari Lebih Lanjut → |

**Card 3 — SaaS & Ekosistem Digital:**
| Elemen | Content |
|--------|---------|
| **Icon** | Network / Ecosystem |
| **Title** | SaaS & Ekosistem Digital |
| **Description** | Produk SaaS dari Webifylab yang saling terintegrasi, siap di-scale dengan AI & Data untuk efisiensi maksimal. |
| **Features List** | • Produk SaaS siap pakai • Integrasi antar sistem (API-first) • AI & Data Analytics • Automation & Workflow Optimization |
| **CTA** | Pelajari Lebih Lanjut → |
...
| Elemen | Content |
|--------|---------|
| **Icon** | Blueprint / System |
| **Title** | System-First Thinking |
| **Description** | Setiap proyek dimulai dari analisis sistem yang mendalam. Kami tidak langsung coding — kami merancang fondasi yang kuat terlebih dahulu. |

**Item 2:**
| Elemen | Content |
|--------|---------|
| **Icon** | Ecosystem / Network |
| **Title** | Ekosistem, Bukan Sekadar Proyek |
| **Description** | Kami membangun fondasi yang bisa berkembang. Website hari ini bisa menjadi bagian dari ekosistem SaaS besok. |
...
| **Icon** | Brain / AI |
| **Title** | AI & Data Ready |
| **Description** | Dengan keahlian di bidang AI dan Data, kami membantu bisnis Anda siap menghadapi era otomatisasi dan data-driven decision. |

**Item 4:**
| Elemen | Content |
|--------|---------|
| **Icon** | Chat / Transparent |
| **Title** | Transparent & Agile |
| **Description** | Komunikasi terbuka, iterasi cepat, dokumentasi rapi. Anda selalu tahu progress proyek dan bisa memberikan feedback kapan saja. |
...
| **Number** | 01 |
| **Title** | Discovery |
| **Description** | Kami mendengarkan kebutuhan bisnis Anda, menganalisis masalah, dan mendefinisikan tujuan yang jelas. |
...
| **Description** | Kami merancang arsitektur sistem, wireframe, dan roadmap pengembangan yang detail dan terukur. |
...
| **Number** | 03 |
| **Title** | Development |
| **Description** | Kami membangun solusi dengan tech stack modern, mengikuti best practices, dan melakukan testing ketat. |
...
- **AI & Data:** TensorFlow, PyTorch, LangChain, Pandas
...
| Elemen | Content |
|--------|---------|
| **Thumbnail** | [Gambar placeholder dengan overlay "Coming Soon"] |
...
| Elemen | Content |
|--------|---------|
| **Text** | Testimonial akan segera ditampilkan setelah proyek pertama selesai. |

**Alternative: Gunakan "Trusted By" section:**
| Elemen | Content |
|--------|---------|
| **Section Title** | Dipercaya Oleh |
| **Content** | [Logo-logo perusahaan/klien — jika ada] |
...
| Button | Text | Action |
|--------|------|--------|
| **Primary** | Kirim Pesan → | Submit form |
| **Secondary** | Atau Chat via WhatsApp 💬 | Open WhatsApp (wa.me/...) |

**Success Message (setelah form berhasil dikirim):**
| Elemen | Content |
|--------|---------|
| **Title** | Pesan Terkirim! ✅ |
| **Description** | Terima kasih telah menghubungi kami. Kami akan membalas dalam 1x24 jam kerja. |

**Error Message (jika form gagal):**
| Elemen | Content |
|--------|---------|
...
| **Answer** | Tergantung kompleksitas proyek. Website sederhana bisa selesai dalam 2-4 minggu, sedangkan aplikasi kompleks bisa memakan waktu 2-6 bulan. Kami akan memberikan estimasi timeline yang jelas setelah sesi discovery. |

**Q2:**
| Elemen | Content |
|--------|---------|
| **Question** | Apakah ada garansi setelah proyek selesai? |
| **Answer** | Ya, kami memberikan garansi bug fix selama 30 hari setelah launch. Setelah itu, kami menawarkan paket maintenance bulanan jika Anda membutuhkan dukungan berkelanjutan. |

**Q3:**
| Elemen | Content |
|--------|---------|
| **Question** | Bagaimana sistem pembayaran? |
| **Answer** | Kami menggunakan sistem milestone-based payment. Biasanya 40% di awal, 30% di tengah proyek, dan 30% setelah proyek selesai. Detail akan dibahas di kontrak. |

**Q4:**
| Elemen | Content |
|--------|---------|
| **Question** | Apakah Webifylab bisa menangani proyek jangka panjang? |
| **Answer** | Tentu! Kami memang dirancang untuk menjadi partner teknologi jangka panjang. Banyak klien kami yang memulai dengan proyek kecil, lalu berkembang menjadi retainer bulanan untuk maintenance dan pengembangan fitur baru. |

**Q5:**
| Elemen | Content |
|--------|---------|
| **Question** | Apakah saya perlu paham teknis untuk bekerja dengan Webifylab? |
| **Answer** | Tidak perlu. Kami akan menjelaskan semua hal teknis dengan bahasa yang mudah dipahami. Yang penting, Anda punya visi bisnis yang jelas — kami yang akan menerjemahkannya menjadi solusi teknis. |
...
Sebelum deploy, pastikan semua konten berikut sudah final:

- [ ] Headline dan sub-headline untuk semua section
- [ ] Deskripsi untuk semua card (Problem, Services, Why Webifylab)
- [ ] Label dan placeholder untuk form kontak
- [ ] Validation messages untuk form
- [ ] Success dan error messages
- [ ] FAQ questions dan answers
- [ ] Meta tags (title, description, OG, Twitter)
- [ ] Footer content (copyright, links, contact)
- [ ] WhatsApp pre-filled message
- [ ] 404 page content
